...
## Skills
`HTML5` , `CSS3` , `JavaScript` , `TypeScript` , `React.js` , `Vue.js` , `Angular` , `SASS` , `Webpack` , `Next.js` , `Astro` , `SSR` , `SSG` , `ISR` , `CMS` , `I18n` , `A11Y (Accessibility)` , `Node.js` , `NgRx` , `Lit.js` , `GraphQL` , `UX (User Experience)` , `Design Systems` , `PWA` , `Adobe AEM` , `Module Federation`, `Spec-driven Development`, `Agentic AI Software Engineering`
